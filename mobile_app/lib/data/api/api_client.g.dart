...
class _ApiClient implements ApiClient {
  ...
  Future<List<AppThemeModel>> getThemes({String? search}) async {
    ...
    late List<AppThemeModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => AppThemeModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<List<BookAuthorModel>> getBookAuthors({
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<BookAuthorModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              BookAuthorModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
